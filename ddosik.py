...
def credit():
    ...
    stdout.write(""+Fore.RED+" ╚═════╝╚═╝  ╚═╝╚══════╝╚═════╝ ╚═╝   ╚═╝   \n")
    stdout.write(""+Fore.RED+"╔═════════════════════════════╗\n")
    stdout.write(" "+Fore.LIGHTWHITE_EX+"Developer "+Fore.RED+": \x1b[38;2;0;255;189mXeldra.EU\n")
    stdout.write(" "+Fore.LIGHTWHITE_EX+"https://discord.gg/U9N9q8hQgN\n")
    stdout.write(""+Fore.RED+"╚═════════════════════════════╝\n")
    stdout.write("\n")    
##############################################################################################
def layer7():
...
def title():
    ...
    stdout.write("   "+Fore.RED+"       ╚═══╦═══════════════════╦═══╝\n")
    stdout.write("   "+Fore.RED+"  ╚╦═══════╩═══════════════════╩═══════╦╝\n")
    stdout.write("   "+Fore.RED+"   ║ "+Fore.LIGHTCYAN_EX+" Welcome "+Fore.LIGHTWHITE_EX+"To The "+Fore.RED+"SATAN"+Fore.LIGHTWHITE_EX+" Tools DDos "+Fore.RED+" ║                  \n")
    stdout.write("   "+Fore.RED+"   ║ "+Fore.BLUE+"  https://discord.gg/U9N9q8hQgN "+Fore.RED+"  ║                \n")
    stdout.write("   "+Fore.RED+"   ║  "+Fore.WHITE+" Type "+Fore.LIGHTGREEN_EX+"[help]"+Fore.WHITE+" View The Commands "+Fore.RED+"  ║                     \n")
    stdout.write("   "+Fore.RED+"   ╚═══════════════════════════════════╝         \n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.BLUE+"╔═══"+Fore.BLUE+"["+Fore.MAGENTA+"root"+Fore.BLUE+"●"+Fore.RED+"ADMIN"+Fore.BLUE+"]"+Fore.BLUE+"\n╚══"+Fore.BLUE+"> "+Fore.WHITE)
    command = input()
